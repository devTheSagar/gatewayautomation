                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ count($message) }}</h3>
                                    <p class="text-muted fs-13 mb-0">Total Messages</p>
                                </div>
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ count($service) }}</h3>
                                    <p class="text-muted fs-13 mb-0">Total Services</p>
                                </div>
                                <div class="col col-auto top-icn dash">
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ count($client) }}</h3>
                                    <p class="text-muted fs-13 mb-0">Clients Served</p>
                                </div>
                                <div class="col col-auto top-icn dash">
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-semibold">{{ count($industries) }}</h3>
                                    <p class="text-muted fs-13 mb-0">Served Industries</p>
                                </div>
                                <div class="col col-auto top-icn dash">

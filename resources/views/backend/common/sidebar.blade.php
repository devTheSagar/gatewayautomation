            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.add.carousel') }}" class="slide-item">Add carousel</a></li>
                        <li><a href="{{ route('admin.all.carousel') }}" class="slide-item">All carousel</a></li>
                    </ul>
                </li>
                <li class="slide">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.add.success-stories') }}" class="slide-item">Add success story</a></li>
                        <li><a href="{{ route('admin.all.success-stories') }}" class="slide-item">All success stories</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.all.service') }}" class="slide-item">All services</a></li>
                    </ul>
                </li>
                <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('admin.brochure') }}">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="side-menu__icon"
                            viewBox="0 0 24 24"
                            fill="none"

                            ...
                            <form action="{{ route('admin.store.testimonial') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <input id="company_logo" name="company_logo" type="file" class="dropify" data-height="200" />
                                        @error('company_logo')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="client_name" class="form-control @error('client_name') is-invalid @enderror" maxlength="250" id="client_name" value="{{ old('client_name') }}">
                                    @error('client_name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="client_designation" class="form-control @error('client_designation') is-invalid @enderror" maxlength="250" id="client_designation" value="{{ old('client_designation') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('testimonial_content') is-invalid @enderror" name="testimonial_content" maxlength="3000" id="textarea" rows="3" id="testimonial_content">{{ old('testimonial_content') }}</textarea>
